...
const getAllowedTransitions = (currentStatus) => {
  ...
  if (currentStatus === STATUS.DIAGNOSTICO) return [STATUS.EN_PROCESO, STATUS.LISTA, STATUS.RECIBIDA, STATUS.CANCELADA];
  if (currentStatus === STATUS.EN_PROCESO) return [STATUS.LISTA, STATUS.DIAGNOSTICO, STATUS.RECIBIDA, STATUS.CANCELADA];
  if (currentStatus === STATUS.LISTA) return [STATUS.ENTREGADA, STATUS.EN_PROCESO, STATUS.CANCELADA];
  return ORDER;
};
